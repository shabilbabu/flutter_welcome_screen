...
class $AssetsIconsGen {
  ...
  /// List of all assets
  List<AssetGenImage> get values => [phoneIcon, userIcon];
}

class $AssetsImagesGen {
  const $AssetsImagesGen();

  /// File path: assets/images/welcome screen one.png
  AssetGenImage get welcomeScreenOne =>
      const AssetGenImage('assets/images/welcome screen one.png');

  /// File path: assets/images/welcome screen three.png
  AssetGenImage get welcomeScreenThree =>
      const AssetGenImage('assets/images/welcome screen three.png');

  /// File path: assets/images/welcome two image.png
  AssetGenImage get welcomeTwoImage =>
      const AssetGenImage('assets/images/welcome two image.png');

  /// List of all assets
  List<AssetGenImage> get values =>
      [welcomeScreenOne, welcomeScreenThree, welcomeTwoImage];
}
